...
--
-- Host: 127.0.0.1
-- Creato il: Feb 22, 2022 alle 17:07
...
('APPIP4109', 'Apple iPad Air 10.9\" (quarta gen.)', 'Apple', 669, 500, 8, 'tablet', 1, 1),
('APPIPHN13', 'IPhone 13', 'Apple', 1099, 999, 0, 'smartphone', 1, 1),
('APPLIPH8P', 'Iphone 8 Plus', 'apple', 599, 400, 3, 'smartphone', 1, 1),
('F515EA-EJ1134T', 'ASUS Notebook', 'ASUS', 474, 2, 87, 'pc', 1, 1),
('HPNTBK255', 'HP Notebook 255', 'HP', 899, 700, 0, 'pc', 0, 0),
('LLWMT8PB4100', 'iPhone 8 Plus Batteria compatibile 4100 mAh ', 'LLWMT', 20, 15, 19, 'pezzo', 0, 1),
('M2010J19SG', 'Display Redmi 9T compatibile', 'E-YIIVIIL', 60, 48.9, 2, 'pezzo', 2, 1),
('OP8T', 'OnePlus 8T', 'OnePlus', 599, 450, 25, 'smartphone', 1, 1),
('OP8T-comeNuovo', 'OnePlus 8T - comeNuovo', 'OnePlus', 479.2, NULL, 25, 'smartphone', 1, 1),
('OP8T-danniEvidenti', 'OnePlus 8T - danniEvidenti', 'OnePlus', 239.6, NULL, 14, 'smartphone', 1, 1),
('OP8T-danniLeggeri', 'OnePlus 8T - danniLeggeri', 'OnePlus', 359.4, NULL, 18, 'smartphone', 1, 1),
('OPN100', 'OnePlus Nord N100', 'OnePlus', 199, 139, 10, 'smartphone', 1, 1),
